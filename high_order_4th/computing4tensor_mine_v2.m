function [L1,embedding] = computing4tensor_mine_v2(A,knn,num_cluster)
...
[dk, site] = tensor_clustering_tcyb(A,H,knn);% n*knn^3; A:input, n_sample * n_feature; H: distance matrix; knn: number of knn
