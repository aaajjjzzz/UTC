function [V_1,V_2,iter] = ASL23_um(L1,L3,cls_num,opts,lambda2)
% Solve the High order similarity(3+2) problem Multi-Clustering  unified
% model
%
...
%         end
        ...
        %Update V1
        V1_k = update_V1_L23(V1_k,V2_k,L1,L3,Y1_k,Y2_k,mu,alpha,1);
...
%         end
        ...
        V2_k = (L3*(V1_k)+Y1_k+mu*(kron_col(V1_k)))./mu;
...
function Z = obj_f(V1,V2,L1,L3,mu,Y1,Y2)
    [m1,n1] = size(V1);
    [m2,n2] = size(V2);
    z1 = trace(V1'*L1*V1);
    %z2 = trace(V2'*L2*V2);
