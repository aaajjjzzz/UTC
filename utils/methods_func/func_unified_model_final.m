function finale_result = func_unified_model_final(data,gt,dataset_name,save_path, order4_sim_opt, L2_opt)
...
%  
    ...
    %% undecom
    %2+3 order
    lambda = [0.01:0.02:0.1 0.15:0.05:1, 1, 1.5]; cell_it= 1; embedding_bank={};results_bank = {};
    %lambda_2 = [0.05, 0.1, 0.25, 0.5, 0.75,1,1.5];
    lambda_2 = [0.01:0.02:0.1 0.15:0.05:1, 1, 1.5];
...
%             [V_1_ADMM_L23,V_2_ADMM_L23,iter_L23] = ASL23_um(L_2,L_3,cls_num,opts,lambda2);
...
%             [V_1_ADMM_L24,V_2_ADMM_L24,iter_L24] = ASL24_um(L_2,L_4,cls_num,opts,lambda1);
